...
// href starts with /comp4020-ass1-anpham-09/ — and linkinator resolved those
// against dist/, looking for dist/comp4020-ass1-anpham-09/menu/ and reporting
...
function internalRefs(doc: Document): string[] {
  return [...doc.querySelectorAll("[href], [src]")]
    ...
    .filter((ref) => ref !== "" && !external.test(ref));
}
